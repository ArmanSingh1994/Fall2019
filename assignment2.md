...
## Instructions
 ...
 1. Complete exercise D. Complete the project on MDN *Structuring a page of content* in Unit 4. 
	 ...
	 - use this page to create the secondary pages in the `content` sub-directory (`get_started.html`, `photos.html`, `gear.html`, `forum.html`. Include descriptive headings and paragraphs of lorem ipsum text to fill in the main and aside containers.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NzQwMzI0MjgsNzU0OTg3MzgxLC0xND
U4MDEyMzM4XX0=
-->