...
## Instructions
 ...
 1. Complete exercise D. Complete the project on MDN *Structuring a page of content* in Unit 4. 
	 ...
	 - use this page to create the secondary pages in the `content` sub-directory (`get_started.html`, `photos.html`, `gear.html`, `forum.html`. Include descriptive headings and paragraphs of lorem ipsum text to fill in the main and aside containers. Do not duplicate, make each page different (copy different text and have different number of 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE4MTk2ODA3LDc1NDk4NzM4MSwtMTQ1OD
AxMjMzOF19
-->