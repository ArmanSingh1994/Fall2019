...
## Instructions
 ...
 2. this page will be the home page. Use their css only to verify that your structure is correct, then remove the link and the css file
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNzA1OTQ2MjFdfQ==
-->